    ...
    def generate_note(transcript: str, model: str = 'deepseek-r1:1.5b', previous_note: str = None, is_complete: bool = True) -> str:
        ...
        try:
            ...
            system_message['content'] += (
                ...
                "note following standard Subjective, Objective, Assessment, and Plan (SOAP) format:\n\n"
                "SUBJECTIVE (S):\n"
                ...
                "Don't include any pre-amble or commentary."
            )
